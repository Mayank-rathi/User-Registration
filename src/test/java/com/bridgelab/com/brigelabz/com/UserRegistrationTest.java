...
public class UserRegistrationTest {
    ...
    @Test
    public void givePasswordWithAtLeastOneUpperCaseLatterEightCharactersAndOneDigitAndAtleastOneSpecialCharacter_WhenProper_ShouldReturnTrue() {
        boolean result = UserValidation.validatePassword("MAEEMAYANK33-",UserValidation.PASSWORD4);
        Assert.assertEquals(true, result);
    }
    @Test
    public void givePasswordWithAtLeastOneUpperCaseLatterEightCharactersAndOneDigitAndAtleastOneSpecialCharacter_WhenUnProper_ShouldReturnFalse()
    {
